 ...
 */
public class Comment implements Serializable, Schema {
     ...
     */
    public Comment(CommentOnVideoRequest grpcReauest) {
        this.videoid    = fromString(grpcReauest.getVideoId().getValue());
        this.commentid  = fromString(grpcReauest.getCommentId().getValue());
        this.userid     = fromString(grpcReauest.getUserId().getValue());
        this.comment    = grpcReauest.getComment();
    }
